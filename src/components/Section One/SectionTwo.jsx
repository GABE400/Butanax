...
import SectionImg from '../../assets/stepup.png';
import SectionCall from '../../assets/stepstand.png';
import SectionDoor from '../../assets/pest.png';

const SectionTwo = () => {
  return (
    <section class='pt-96 mt-28 sm:pt-40-c md:mt-0'>
      <div class='container mx-auto px-4'>
        <hr class='w-4/5 mx-auto h-0.5 bg-gray-200 md:w-2/5  sm:mt-0 lg:mt-60' />
        ...
        <div class='flex flex-col justify-evenly items-center py-10 md:flex-row'>
          ...
          <div class='text-center md:text-left'>
            <span class='text-red-500 font-semibold'>Butanax Team</span>
        ...
        <div class='flex flex-col justify-evenly items-center py-10 md:flex-row'>
          <div class='text-center mb-10 order-1 md:order-2'>
            <img src={SectionImg} alt='app screen' />
          </div>

          <div class='text-center md:text-left order-2 md:order-1'>
            <span class='text-red-500 font-semibold'>What we use</span>
        ...
        <div class='flex flex-col justify-evenly items-center py-10 md:flex-row'>
          <div class='text-center mb-10'>
            <img src={SectionDoor} alt='app screen' />
          </div>
