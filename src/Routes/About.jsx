      ...
      <div className='w-full md:w-2/3 lg:w-1/2 bg-white p-8 rounded-lg shadow-lg'>
        <div className='flex flex-col md:flex-row md:items-center mb-8'>
          ...
          <div className='flex flex-col items-center md:items-start'>
            ...
            <p className='text-gray-600 text-lg'>
              ...
              problem, from common household pests like ants and cockroaches to
              more specialized pests like termites and bed bugs.
            </p>
          </div>
        </div>
        <div className='text-lg text-gray-600'>
          <p>
            ...
            believe in taking a proactive approach to pest control, which means
            working with our clients to develop customized treatment plans that
            address their specific pest problems and prevent future
            infestations.
          </p>
          <p>
            At Butanax Pest Control, we use only the safest and most effective
            pest control products and techniques. We are committed to protecting
            both our clients and the environment, which is why we use
            eco-friendly products whenever possible. We also believe in
          ...
          <p>
            ...
            consultation and learn more about how we can help you eliminate your
            pest problems for good.
          </p>
        </div>
      </div>
    </div>
